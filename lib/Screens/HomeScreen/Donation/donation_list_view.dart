...
import'enter_donation_recharge_detail_screen.dart';
class DonationListviewScreen extends StatelessWidget {
  DonationListviewScreen({Key? key}) : super(key: key);
    ...
    return ScrollConfiguration(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) => Padding(
          ...
          child: InkWell(
            onTap: () {
              Get.to(()=>EnterDonationRechargeDetailScreen());
            },
            child: Container(
              width: Get.width,
